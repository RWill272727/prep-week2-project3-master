...
var i = 0;
while (i < 5) {
    text += "<br>This is how a professional loops.";
    i++;
}
...
var i = 10;
while (i <= 110) {
    text += "<br>At home I have " + i + " cats.";
    i+=25;
}
document.getElementById("q5").innerHTML = text;
...
for(i=0; i<hashTag.length; i++) {
    document.getElementById("q8").innerHTML += "<p>" + hashTag[i] + "</p>";
}
...
var computerPick= "";
var message = "";
document.getElementById("rpsButton").addEventListener("click", function() {
  var human = document.getElementById("rpsInput").value;
...
if (computerPick == "Rock" && human == "Scissors") {
  message = "You lose, the computer chose " + computerPick + ".";
} else if (computerPick == "Rock" && human == "Paper") {
  message = "You win, the computer chose " + computerPick + ".";
} else if (computerPick == "Paper" && human == "Rock") {
  message = "You lose, the computer chose " + computerPick + ".";
} else if (computerPick == "Paper" && human == "Scissors") {
  message = "You win, the computer chose " + computerPick + ".";
} else if (computerPick == "Scissors" && human == "Rock") {
  message = "You win, the computer chose " + computerPick + ".";
} else if (computerPick == "Scissors" && human == "Paper") {
  message = "You lose, the computer chose " + computerPick + ".";
}
  // Display Data
  document.getElementById("q10").innerHTML = message;
});
